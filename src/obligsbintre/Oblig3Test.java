...
//    antallFeil += oppgave10();
    ...
    public static int oppgave3() {
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 3e: Her kastes et unntak! Det skal ikke skje!");
        }
...
// OPPGAVE 4 ////////////////////////////////////////////////    
    ...
    public static int oppgave5() {
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 5o: Skal ikke kaste unntak når et tomt tre nullstilles!");
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 5q: Kaster unntak i fjernAlle(T) for tomt tre!");
        }
        ...
        try {
            if (tre.fjernAlle(0) != 1) {
                antallFeil++;
                System.out.println("Oppgave 5r: Feil i fjernAlle(T) for tre med en verdi!");
            }
        } catch (Exception e) {
            antallFeil++;
            System.out.println("Oppgave 5s: Kaster unntak i fjernAlle(T) for tre med en verdi!");
        }
        ...
        for (int i = 0; i < 500_000; i++) {
            tre.leggInn(r.nextInt(1_000_000));
        }
    ...
    public static int oppgave6() {
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 6b: Det skal ikke kastes unntak for et tomt tre!");
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 6h: Det skal ikke kastes unntak for et tomt tre!");
        }
    ...
    public static int oppgave7() {
        ...
        try {
            if (s.length != 0) {
                antallFeil++;
                System.out.println("Oppgave 7a: Feil i grener() for tomt tre!");
            }
        } catch (Exception e) {
            antallFeil++;
            System.out.println("Oppgave 7b: Metoden grener() skal ikke kaste unntak for et tomt tre!");
        }
        ...
        if (!t.equals("[[10]]")) {
            antallFeil++;
            System.out.println("Oppgave 7c: Feil i grener() for et tre med en verdi!");
        }
        ...
        if (!t.equals("[[10, 6, 9, 7, 8]]")) {
            antallFeil++;
            System.out.println("Oppgave 7d: Feil grener() for tre med en gren!");
        }
        ...
        if (!s[0].equals("[4, 1, 3, 2]") || !s[1].equals("[4, 6, 5]")
            ...
            antallFeil++;
            System.out.println("Oppgave 7e: Feil i metoden grener()!");
        }
    ...
    public static int oppgave8() {
        ...
        try {
            if (!s.equals("[]")) {
                antallFeil++;
                System.out.println("Oppgave 8aa: Skal returnere [] for tomt tre!");
            }
        } catch (Exception e) {
            antallFeil++;
            System.out.println("Oppgave 8ab: Skal ikke kaste unntak for et tomt tre!");
        }
        ...
        if (!s.equals("[10]")) {
            antallFeil++;
            System.out.println("Oppgave 8ac: Feil - du har " + s + ", det skal være [10].");
        }
        ...
        if (!s.equals("[11]")) {
            antallFeil++;
            System.out.println("Oppgave 8ad: Feil - du har " + s + ", det skal være [11].");
        }
        ...
        if (!s.equals("[6, 9, 12, 14, 16]")) {
            antallFeil++;
            System.out.println("Oppgave 8ae: Feil - du har " + s + ", det skal være [6, 9, 12, 14, 16].");
        }
        ...
        if (!s.equals("[5]")) {
            antallFeil++;
            System.out.println("Oppgave 8af: Feil - du har " + s + ", det skal være [5].");
        }
        ...
        if (poststring.compareTo("[]") != 0) {
            antallFeil++;
            System.out.println("Oppgave 8ba: Feil - du har " + poststring + ", det skal være [].");
        }
        ...
        if (poststring.compareTo("[10]") != 0) {
            antallFeil++;
            System.out.println("Oppgave 8bb: Feil - du har " + poststring + ", det skal være [10].");
        }
        ...
        if (poststring.compareTo("[15, 10]") != 0) {
            antallFeil++;
            System.out.println("Oppgave 8bc: Feil - du har " + poststring + ", det skal være [15, 10].");
        }
        ...
        if (poststring.compareTo(svar) != 0) {
            antallFeil++;
            System.out.println("Oppgave 8bd: Feil - du har " + poststring + ",");
            System.out.println("             det skal være " + svar);
        }
    ...
    public static int oppgave9() {
        ...
        try {
            ...
            if (!(e instanceof NoSuchElementException)) {
                antallFeil++;
                System.out.println("Oppgave 9b: Skal kaste NoSuchElementException her!");
            }
        }
        ...
        try {
            i.next();
            antallFeil++;
            System.out.println("Oppgave 9d: Skal kaste unntak når det ikke er flere igjen!");
        } catch (Exception e) {
            if (!(e instanceof NoSuchElementException)) {
                antallFeil++;
                System.out.println("Oppgave 9e: Skal kaste NoSuchElementException her!");
            }
        }
        ...
        if (!s.equals("[1, 3, 7, 9]")) {
            antallFeil++;
            System.out.println("Oppgave 9f: Feil - du har " + s + ", det skal være [1, 3, 7, 9].");
            System.out.println("            Din iterator skal kun gå gjennom bladnodene!");
        ...
        if (verdi != 4) {
            antallFeil++;
            System.out.println("Oppgave 9g: Treet har kun 4 som bladnodeverdi!");
        }
        ...
        try {
            ...
            System.out.println("Oppgave 9h: Har du oppdatert endringer i leggInn?");
        } catch (Exception e) {
            if (!(e instanceof ConcurrentModificationException)) {
                antallFeil++;
                System.out.println("Oppgave 9i: Her skal du kaste en ConcurrentModificationException!");
            }
        }
        ...
        try {
            ...
            System.out.println("Oppgave 9j: Har du oppdatert endringer i fjern(verdi)?");
        } catch (Exception e) {
            if (!(e instanceof ConcurrentModificationException)) {
                antallFeil++;
                System.out.println("Oppgave 9k: Her skal du kaste en ConcurrentModificationException!");
            }
        }
        ...
        try {
            ...
            System.out.println("Oppgave 9l: Har du oppdatert endringer i nullstill()?");
        } catch (Exception e) {
            if (!(e instanceof ConcurrentModificationException)) {
                antallFeil++;
                System.out.println("Oppgave 9m: Her skal du kaste en ConcurrentModificationException!");
            }
        }
    ...
    public static int oppgave10() {
        ...
        try {
            ...
            if (!(e instanceof IllegalStateException)) {
                antallFeil++;
                System.out.println("Oppgave 10b: Skal kaste IllegalStateException her!");
            }
        }
        ...
        try {
            ...
            if (!(e instanceof IllegalStateException)) {
                antallFeil++;
                System.out.println("Oppgave 10d: Skal kaste IllegalStateException her!");
            }
        }
        ...
        try {
            ...
            System.out.println("Oppgave 10e: Har du oppdatert endringer i iteratorens remove()?");
        } catch (Exception e) {
            if (!(e instanceof ConcurrentModificationException)) {
                antallFeil++;
                System.out.println("Oppgave 10f: Her skal du kaste en ConcurrentModificationException!");
            }
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 10g: Har du oppdatert iteratorendringer i remove()?");
        }
        ...
        try {
            ...
            if (tre.antall() != 8) {
                antallFeil++;
                System.out.println("Oppgave 10i: Feil - må ha antall-- i remove()!");
            }
        } catch (Exception e) {
            antallFeil++;
            System.out.println("Oppgave 10j: Skal ikke kaste unntak her!");
        }
